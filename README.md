...
**CAUTION: This master branch is a development branch that can contain bugs. For productive environments you should use the [current Ruby gem version](https://rubygems.org/gems/alchemy-devise/versions/3.4.0), or the [latest stable branch (3.4-stable)](https://github.com/AlchemyCMS/alchemy-devise/tree/3.4-stable).**
