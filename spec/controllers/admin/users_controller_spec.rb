  ...
  describe Admin::UsersController do
    ...
    describe '#index' do
      context 'with search query' do
        it "lists all matching users" do
          User.stub_chain(:where, :page, :per, :order).and_return([user])
      ...
      context 'without search query' do
        it "lists all users" do
          User.stub_chain(:scoped, :page, :per, :order).and_return([user])
          get :index
          assigns(:users).should include(user)
        end
      end
    ...
    describe '#update' do
      ...
      it "assigns user to @user" do
        xhr :post, :update, id: user.id, user: {email: user.email}
      ...
      context "with empty password passed" do
        it "should update the user" do
          ...
          xhr :post, :update, id: user.id, user: params_hash
        end
      end
      ...
      context "if user is permitted to update roles" do
        ...
        it "updates the user including role" do
          ...
          xhr :post, :update, id: user.id, user: {alchemy_roles: ['Administrator']}
        end
      end
