  ...
  class User < ActiveRecord::Base
    ...
    class << self
      ...
      def search(query)
        ...
        where(
          arel_table[:login].lower.matches(query).or \
            arel_table[:email].lower.matches(query).or \
              arel_table[:firstname].lower.matches(query).or \
                arel_table[:lastname].lower.matches(query)
        )
      end
    end
